...
router.get('/bus/payment/:status/filter', busPaymentController.filterPayment)
router.get('/bus/payment/:status/:id/view', busPaymentController.viewPayment)
router.get('/bus/payment/:status/:id/invoice', busPaymentController.invoicePayment)
router.get('/bus/payment/:id/accept', busPaymentController.acceptPayment)
